 package com.example.covod_19tracker;
...
import java.util.List;
 ...
 public class AffectedCountries extends AppCompatActivity {
    ...
    MyCustomAdapater myCustomAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                myCustomAdapater.getFilter().filter(s);
                myCustomAdapater.notifyDataSetChanged();
                     ...
                     public void onResponse(String response) {
                         ...
                         try {
                             JSONArray jsonArray = new JSONArray(response);
                                     ...
                                     myCustomAdapater  =new MyCustomAdapater(AffectedCountries.this,countryModelsList);
                                     listView.setAdapter(myCustomAdapater );
